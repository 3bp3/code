...
'''
L2 = [randrange(20) for _ in range(nb_of_elements)]
print(f'\nThe list is: {L2}')
print("")
element_strictly_less = [0]*4
for i in range(nb_of_elements):
    element_strictly_less[L2[i]//5] += 1
for i in range(4):
    if element_strictly_less[i] == 0:
        print('There is no element', end = ' ')
    elif element_strictly_less[i] == 1:
        print('There is 1 element', end = ' ')
    else:
        print(f'There are {element_strictly_less[i]} elements', end = ' ')
